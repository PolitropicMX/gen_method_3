...
class Save_module:
    ...
    # HOT NEW--------------------------------------------------------------------------------------------------------------------------------------
    def banner_antes_func(self,banner_antes,fila,n):
        if not banner_antes and n == 1: #antes del titulo
...
##        self.ws.merge_cells("B2:D2")  ESTA NO, POR QUE UNA VEZ SELECCIONADO EL PRODUCTO SE AÑADIRÁ EL EQUIPO A  UTILIZAR
        ...
        images = {'a':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/a.png',# ATENCION
                  ...
                  'r':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/r.png',# MORTAL
                  'b1':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/advertisement.png', # BANNER DE PREPARACION
                  'b2':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/epp.png', # BANNER DE EPP
                  'b3':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/orden.png', # BANNER DE "PESE, CALCULE, ANOTE, AÑADA, TIER/GUARDE"
                  'b4':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/klipton.png', # BANNER DE "MEZCLAR EN 4 PARTES"
                  'b5':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/advert_explo_607.png', # BANNER DE advert. de explosion
                  'b6':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/bullton5085advert.png',# ADVERTENCIA DEL TDI
                  'b7':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/consideraciones_ban.png',# CONSIDERACIONES BÁSICAS ANTES DE EMPEZAR EL PROCESO
                  'b8':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/ADVERLIMPIEZA.png', # MANTENGA LIMPIO SU REACTOR
                  'b9':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/pasarmuestra.png',# PASE MUESTRA A CALIDAD
                  'b10':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/solicitar_fineza.png',# Solicitar Fineza/Finura
                  'b11':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/pasarmuestra2.png',# PASE MUESTRA A CALIDAD bote sucio
                  'b12':'C:/Users/Fernando.Lopez/Downloads/los_codigos/los_codigos/openpyxl/pruebas/evitedispersor.png'# EVITE DEJAR FUNCIONANDO MUCHO TIEMPO EL DISPERSOR
                  }
        # Images = {'a':'Ruta de a',
        #           'c':'Ruta de c',...}
            ...
            for i,reactivo in enumerate(datos_cargados[str(op2)].keys()):
                ...
                if i != len(datos_cargados[str(op2)].keys())-1 and i != len(datos_cargados[str(op2)].keys())-2:
                    ...
                    if reactivo[:4] == "Paso":# LOS PRIMEROS 4 CARACTERES
                        banner_antes = False
                        fila = self.banner_antes_func(banner_antes,fila,n_paso)
                        ...
                        banner_antes = False
                        fila = self.banner_antes_func(banner_antes,fila,n_banner)
                        print(f'{i}# Iteracion ')
